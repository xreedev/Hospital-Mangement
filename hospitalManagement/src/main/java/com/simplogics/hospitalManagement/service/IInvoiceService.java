...
public class IInvoiceService implements InvoiceService {
    ...
    @Override
    public void createExcel(String dest, String startDate, String endDate) throws IOException, NullRequestException, InvalidDataFormatException, NoDependencyException {
        ...
        for(Patient patient:patientIds) {
            ...
            try {
                ...
                throw new InvalidDataFormatException(ExceptionConstants.DATE_FORMAT_NOT_CORRECT);
            }
        }
